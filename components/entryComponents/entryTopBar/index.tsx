...
const EntryTopBar = ({
  ...
  return (
    <div className="p-2 fixed z-10 flex flex-wrap gap-3 justify-between mb-4 mx-5 bg-white rounded-lg">
      <button
      ...
      <button
        ...
        className={`p-2 ${
          disableSaveButtom ? "bg-gray-300" : "bg-blue-800 hover:bg-blue-700"
