      ...
      <div className="flex lg:pt-20 lg:flex-col max-lg:flex-wrap max-lg:gap-1 sm:gap-5 lg:gap-0 items-center max-lg:justify-center flex-1">
        {pages.map((page, index) => (
          <button
            ...
            key={index}
            className={`
              flex items-center max-lg:justify-between lg:px-5 gap-5 lg:w-full hover:cursor-pointer max-lg:mt-2 max-lg:p-3 lg:py-5
               rounded-md text-md sm:text-lg
                lg:text-2xl text-white max-lg:bg-blue-900 hover:bg-blue-700 ${pathname === page.path ? "bg-blue-700" : ""
              }`}
          >
            <Image
              src={page.logoSrc}
      ...
      <div className="flex max-lg:justify-center lg:w-full">
        <button
          ...
          className={`
            ...
            lg:w-full hover:cursor-pointer max-lg:mt-2 max-lg:p-3 lg:py-5 
            rounded-md text-md 
            sm:text-lg lg:text-2xl text-white 
            max-lg:bg-blue-900 hover:bg-blue-700 
